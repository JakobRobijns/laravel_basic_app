 ...
 * Generated for Laravel 7.24.0 on 2020-08-11 16:32:30.
 *
...
namespace Brackets\Translatable\Facades {
    ...
    class Translatable {
         ...
         *
         * @return \Brackets\Translatable\Collection
         * @static
         */
...
namespace Brackets\AdminAuth\Activation\Facades {
    ...
    class Activation {
         ...
         *
         * @param string $name
         * @return \Brackets\AdminAuth\Activation\Brokers\ActivationBrokerContract
         * @static
         */
        public static function broker($name = null)
        {
