...
class UsersController extends Controller
{
    ...
    public function index(IndexUser $request)
    {
        ...
        $data = AdminListing::create(User::class)->processRequestAndGet(
            ...
            ['id', 'firstName', 'lastName', 'username', 'email', 'is_active', 'avatar', 'email_verified_token', 'email_verified_at', 'last_active_at'],

            // set columns to searchIn
            ['id', 'firstName', 'lastName', 'username', 'email', 'avatar', 'email_verified_token']
        );
