...
class FillPermissionsForUserGame extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForUserGame constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.user-game',
            'admin.user-game.index',
            'admin.user-game.create',
            'admin.user-game.show',
            'admin.user-game.edit',
            'admin.user-game.delete',
            'admin.user-game.bulk-delete',
        ]);
