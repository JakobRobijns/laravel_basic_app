                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'is_active'">{{ trans('admin.user.columns.is_active') }}</th>
                                        <th is='sortable' :column="'avatar'">{{ trans('admin.user.columns.avatar') }}</th>
                                        <th is='sortable' :column="'email_verified_token'">{{ trans('admin.user.columns.email_verified_token') }}</th>
                                        <th is='sortable' :column="'email_verified_at'">{{ trans('admin.user.columns.email_verified_at') }}</th>
                                        <th is='sortable' :column="'last_active_at'">{{ trans('admin.user.columns.last_active_at') }}</th>
                                ...
                                <tbody>
                                    <tr v-for="(item, index) in collection" :key="item.id" :class="bulkItems[item.id] ? 'bg-bulk' : ''">
                                        ...
                                        <td>@{{ item.avatar }}</td>
                                        <td>@{{ item.email_verified_token }}</td>
                                        <td>@{{ item.email_verified_at | datetime }}</td>
                                        <td>@{{ item.last_active_at | datetime }}</td>
